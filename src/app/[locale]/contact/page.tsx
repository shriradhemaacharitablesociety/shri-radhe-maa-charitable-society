        ...
        <ScrollReveal delay={600}>
          <div className="mt-16">
            ...
            <div className="space-y-3">
              {[
                {
                  q: "How do I apply for financial assistance or pension?",
                  a: "Please call our Delhi office at 95608 00343 or send an email to shriradhemaacharitablesociety@gmail.com. Our team will guide you through the application process.",
                },
                {
                  q: "How can I volunteer with the society?",
                  a: "We welcome volunteers for distribution drives, event organisation, and seva camps. Visit our Volunteer page or contact us directly to register your interest.",
                },
                {
                  q: "Is my donation eligible for tax deduction?",
                  a: "Donations may be eligible under Section 80G of the Income Tax Act. Contact us to receive your official receipt and the current 80G certificate.",
                },
                {
                  q: "How do I reach the free dialysis centre in Mumbai?",
                  a: "The dialysis centre is at Anand Hospital, 2nd Floor, Dahisar Village, Anand Nagar, Dahisar East, Mumbai – 400068. Call 86570 67228 or 98921 54615 for details.",
                },
              ].map((faq) => (
                <details
                  key={faq.q}
