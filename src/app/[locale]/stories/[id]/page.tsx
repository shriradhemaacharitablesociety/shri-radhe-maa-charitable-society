      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <ScrollReveal delay={100}>
          <div className="mb-8">
            ...
            <h1 className="font-serif text-2xl md:text-3xl lg:text-4xl text-warm-900 tracking-tight mb-1">
              {story.name}
            </h1>
        ...
        <ScrollReveal delay={200}>
          <div className="rounded-2xl border border-crimson-100 bg-crimson-50/40 p-5 sm:p-8 mb-10">
            ...
            <blockquote className="font-serif text-lg sm:text-xl text-warm-900 leading-relaxed italic">
              {story.quote}
            </blockquote>
        ...
        <ScrollReveal delay={500}>
          <div className="rounded-2xl border border-saffron-300/50 bg-saffron-50/40 p-5 sm:p-8 text-center">
