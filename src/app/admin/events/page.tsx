  ...
  return (
    <>
      ...
      <header className="h-16 bg-white border-b border-warm-100 flex items-center justify-between px-8">
        <h1 className="text-lg font-semibold text-warm-900">Events</h1>
                ...
                {placeholderEvents.map((event) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium capitalize ${statusStyles[event.status]}`}
                      >
                        {event.status}
                      </span>
                    </td>
