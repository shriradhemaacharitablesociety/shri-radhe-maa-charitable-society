  ...
  return (
    <>
      ...
      <header className="h-16 bg-white border-b border-warm-100 flex items-center justify-between px-4 sm:px-8">
        <h1 className="text-lg font-semibold text-warm-900">Stories</h1>
      ...
      <div className="p-4 sm:p-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-semibold text-warm-900">Seva Stories</h2>
            <p className="text-warm-500 mt-1">{stories.length} stories total</p>
          </div>
                ...
                {stories.map((story) => (
                  ...
                  >
                    <td className="px-6 py-4">
                      <div>
                        <p className="text-sm font-medium text-warm-900">{story.name}</p>
                        <p className="text-xs text-warm-400 mt-0.5">{story.location}</p>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      {story.featured ? (
                        <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-saffron-100 text-saffron-700">
                          Yes
                        </span>
                      ) : (
