...
export function AboutStrip() {
  return (
    <section className="relative bg-gradient-to-b from-crimson-50 via-saffron-50/50 to-white">
      ...
      <div className="py-10 md:py-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center flex flex-col gap-4 md:gap-6">
              {/* English */}
              ...
              {/* Hindi translation */}
              <p
                className="font-devanagari text-base md:text-xl lg:text-2xl text-warm-600 opacity-60 leading-relaxed"
                lang="hi"
              >
